!(function (e) {
	...
	function (e, t, n) {
					...
					F(e, [
						{
							...
							value: function (e) {
								if (e === R())
									throw new g('expire-custom-caches-only');
		...
		function ae(e) {
			if (!e)
				throw new g('add-to-cache-list-unexpected-type', { entry: e });
			if ('string' === typeof e) {
				var t = new URL(e, location.href);
																	...
																	function (
																		...
																		var t =
																			...
																			a =
																				e.url,
																			i =
																				m._cacheKeysToIntegrities.get(
																					t
																				),
																			c =
																				m._urlsToCacheModes.get(
																					a
																				);
		...
		self.addEventListener('activate', function () {
			...
			(function (e) {
				...
				{
					revision: '0be88c236244089513c0692fb39ca56d',
					url: '/index.html',
				},
				{ revision: null, url: '/static/css/2.e2321b9c.chunk.css' },
				{ revision: null, url: '/static/css/main.4a5c4e25.chunk.css' },
				{ revision: null, url: '/static/js/2.7f6f9b9b.chunk.js' },
				{ revision: null, url: '/static/js/main.d7a342da.chunk.js' },
				{ revision: null, url: '/static/js/runtime-main.1f3179ae.js' },
				{
					revision: null,
					url: '/static/media/AirBnB-TheConsole.de10c4c2.png',
				},
				{
					revision: null,
					url: '/static/media/HeroScreen2.60f9935b.png',
				},
				{ revision: null, url: '/static/media/PetSpot.30da56a8.png' },
				{
					revision: null,
					url: '/static/media/SmilingSchool1.e9db61c0.png',
				},
				{ revision: null, url: '/static/media/myresume.7951912c.pdf' },
				{ revision: null, url: '/static/media/test4.e2aa8aba.png' },
			]),
			pe(_e);
		var Le,
			qe = new RegExp('/[^/?]+\\.[^/]+$');
